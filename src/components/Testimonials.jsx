...
const testimonials = [
  {
    name: "Sarah Johnson",
    role: "CEO, TechStart",
    content: "NovaBusiness transformed our digital strategy. Their insights were invaluable in helping us scale our operations globally.",
    rating: 5
  },
  {
    name: "Michael Chen",
    role: "Director, Global Corp",
    content: "Professional, insightful, and results-oriented. The team at NovaBusiness delivered exactly what we needed to stay ahead of the curve.",
    rating: 5
  },
  {
    name: "Emily Davis",
    role: "Founder, Creative Solutions",
    content: "Working with NovaBusiness was a game-changer. Their strategic planning helped us identify new revenue streams and optimize our workflow.",
    rating: 5
  }
];
