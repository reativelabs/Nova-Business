    ...
    <section id="about" className="py-16 lg:py-24">
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center px-4">
        ...
        <div className="lg:order-1">
          <h2 className="text-4xl font-bold mb-6 text-primary">Why Choose NovaBusiness?</h2>
          <p className="text-xl text-primary mb-6 font-medium">We combine industry expertise with innovative thinking to deliver measurable results.</p>
          <p className="text-text-muted mb-8">At NovaBusiness, we believe that every business has the potential to achieve greatness. Our team of experienced consultants works closely with you to understand your unique challenges and develop tailored solutions that drive growth and efficiency.</p>
